...
/**
 * Calculate the moment matrix element for
 * @param atom_1 the first atom
 * @param orbit_1 the orbital of the first atom
 * @param n1x the power of (x-R1x) in front of the first Gaussian basis function
 * @param n1y the power of (y-R1y) in front of the first Gaussian basis function
...
double MxElemFiller::Moment(int atom_1, int orbit_1, int n1x, int n1y, int n1z, int atom_2, int orbit_2, int n2x, int n2y, int n2z, R & Rp, int npx, int npy, int npz){
   ...
   for (int i=0; i<Ncontr1; i++)
      for (int j=0; j<Ncontr2; j++){
         ...
         alpha1 = A1->galpha(orbit_1,i);
         alpha2 = A2->galpha(orbit_2,j);
         intermediate = MomentRecursion(alpha1, alpha2, R1, R2, Rp, n1x, n1y, n1z, n2x, n2y, n2z, npx, npy, npz);
         theElement += (A1->gprefactors(orbit_1,i))*(A2->gprefactors(orbit_2,j))*NormCst(alpha1,n1x,n1y,n1z)*NormCst(alpha2,n2x,n2y,n2z)*intermediate;
...
/**
 * Recursion relation for the calculation of a the moment (x-Rp_x)^npx*(y-Rp_y)^npy*(z-Rp_z)^npz
 * @param alpha1 first gaussian power parameter
 * @param alpha2 second gaussian power parameter
 * @param R1 the center of the first gaussian
 * @param R2 the center of the second gaussian
 ...
 * @return the moment matrix element of a step in the recursion
 */
double MxElemFiller::MomentRecursion(double alpha1, double alpha2, R & R1, R & R2, R&Rp, int n1x, int n1y, int n1z, int n2x, int n2y, int n2z, int npx, int npy, int npz){

   if ((n1x<0)||(n1y<0)||(n1z<0)||(n2x<0)||(n2y<0)||(n2z<0)||(npx<0)||(npy<0)||(npz<0))
      return 0.0;
                  ...
                  if (n2z==0){
                     if (npx==0){
                        if (npy==0){
                           if (npz==0){
                              //All zero:
                              return pow(M_PI/zeta,1.5) * exp(- xi*R1.DistanceSquared(R2));
                           }
                           // npz is not zero; rest is zero
                           return ((alpha1*(R1.gzco()) + alpha2*(R2.gzco()))/(alpha1+alpha2)-Rp.gzco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z, npx,npy,npz-1)+0.5/zeta*(npz-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z,npx,npy,npz-2);
                        }
                        //npz and npy not zero
                        return ((alpha1*(R1.gyco()) + alpha2*(R2.gyco()))/(alpha1+alpha2)-Rp.gyco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z, npx,npy-1,npz)+0.5/zeta*(npy-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z,npx,npy-2,npz);
                     }
                     //npz,npy and npx not zero
                     return ((alpha1*(R1.gxco()) + alpha2*(R2.gxco()))/(alpha1+alpha2)-Rp.gxco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z, npx-1,npy,npz)+0.5/zeta*(npx-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z,npx-2,npy,npz);
                  }
                  //n2z not zero
                  return ((alpha1*(R1.gzco()) + alpha2*(R2.gzco()))/(alpha1+alpha2)-R2.gzco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z-1, npx,npy,npz)+0.5/zeta*(n2z-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z-2,npx,npy,npz)+0.5/zeta*n1z*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z-1,n2x,n2y,n2z-1,npx,npy,npz)+0.5/zeta*npz*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y,n2z-1,npx,npy,npz-1);
               }
               //n1z not zero
               return ((alpha1*(R1.gzco()) + alpha2*(R2.gzco()))/(alpha1+alpha2)-R1.gzco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z-1,n2x,n2y,n2z,npx,npy,npz)+0.5/zeta*(n1z-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z-2,n2x,n2y,n2z,npx,npy,npz)+0.5/zeta*n2z*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z-1,n2x,n2y,n2z-1,npx,npy,npz)+0.5/zeta*npz*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z-1,n2x,n2y,n2z,npx,npy,npz-1);
            }
            //n2y not zero
            return ((alpha1*(R1.gyco()) + alpha2*(R2.gyco()))/(alpha1+alpha2)-R2.gyco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y-1,n2z,npx,npy,npz)+0.5/zeta*(n2y-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y-2,n2z,npx,npy,npz)+0.5/zeta*n1y*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y-1,n1z,n2x,n2y-1,n2z,npx,npy,npz)+0.5/zeta*npy*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x,n2y-1,n2z,npx,npy-1,npz);
         }
         //n1y not zero
         return ((alpha1*(R1.gyco()) + alpha2*(R2.gyco()))/(alpha1+alpha2)-R1.gyco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y-1,n1z,n2x,n2y,n2z,npx,npy,npz)+0.5/zeta*(n1y-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y-2,n1z,n2x,n2y,n2z,npx,npy,npz)+0.5/zeta*n2y*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y-1,n1z,n2x,n2y-1,n2z,npx,npy,npz)+0.5/zeta*npy*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y-1,n1z,n2x,n2y,n2z,npx,npy-1,npz);
      }
      //n2x not zero
      return ((alpha1*(R1.gxco()) + alpha2*(R2.gxco()))/(alpha1+alpha2)-R2.gxco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x-1,n2y,n2z,npx,npy,npz)+0.5/zeta*(n2x-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x-2,n2y,n2z,npx,npy,npz)+0.5/zeta*n1x*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x-1,n1y,n1z,n2x-1,n2y,n2z,npx,npy,npz)+0.5/zeta*npx*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x,n1y,n1z,n2x-1,n2y,n2z,npx-1,npy,npz);
   }
   //n1x not zero
   return ((alpha1*(R1.gxco()) + alpha2*(R2.gxco()))/(alpha1+alpha2)-R1.gxco())*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x-1,n1y,n1z,n2x,n2y,n2z,npx,npy,npz)+0.5/zeta*(n1x-1)*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x-2,n1y,n1z,n2x,n2y,n2z,npx,npy,npz)+0.5/zeta*n2x*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x-1,n1y,n1z,n2x-1,n2y,n2z,npx,npy,npz)+0.5/zeta*npx*MomentRecursion(alpha1,alpha2,R1,R2,Rp,n1x-1,n1y,n1z,n2x,n2y,n2z,npx-1,npy,npz);
